    ...
    public class AzureStorageService : IAzureStorageService
    {
            ...
            ILogger<AzureStorageService> logger)
        {
            string connectionString =
                ...
                ?? configuration["ConnectionStrings:StorageConnectionString"]
                ?? throw new InvalidOperationException("Azure Storage connection string not found. Checked keys: ConnectionStrings:AzureStorage, Storage, StorageConnectionString.");
        ...
        public async Task<T> UpdateEntityAsync<T>(T entity) where T : class, ITableEntity
        {
            ...
            try
            {
                // Use IfMatch condition when ETag is present; otherwise, allow unconditional update
                var ifMatch = entity.ETag.Equals(default(Azure.ETag)) ? Azure.ETag.All : entity.ETag;
                await tableClient.UpdateEntityAsync(entity, ifMatch, TableUpdateMode.Replace);
                return entity;
            }
